...
bot = telebot.TeleBot('1575991983:AAE_iesNFrJ814Fgt8nTm2w_LFtwKr7baFo') # Токен бота воркеров

admin = 1362884146 # ID Админа
support = 1405105161 # ID сапорта
channel_id = -1001213533188 # ID Канала залётов
chat_worker_id = -297265572 # ID Чата с воркерами

bot_name = 'HolyWorker_bot' # Username Бота
...
pname = 'HolyCasino' # Название проекта
pdate = '24.01.2021' # Дата созданя проекта
