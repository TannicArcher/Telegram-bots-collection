...
#конфиг
BOT_TOKEN = '5746137264:AAEKGLWiviX2KuMRLO7XS4FE9vp1QKQvVe0'#Токен бота
ADMIN_LIST = [5657008810] #Id админа
...
async def start(message : types.Message, state: FSMContext):
    ...
    await bot.send_message(message.chat.id, f'<b>👋 Привет! Это Анонимный чат Телеграма.</b>\n'
                                            ...
                                            f'<i>Удачного общения! Будьте вежливы к собеседникам.</i> t.me/archerdeveloping',reply_markup=mark_menu, parse_mode=types.ParseMode.HTML)
