...
start_menu = '#СЛИТО В @END_RAID Здравствуйте, {name}\n' \
        'Ваш id - {id}\n' \
        'Вы находитесь в меню:'


admin_menu = '#СЛИТО В @END_RAID Здравствуйте, {name}\n' \
             'Вы находитесь в меню админа: '


profile = '#СЛИТО В @END_RAID📰 Профиль\n\n' \
          'Ваше имя - {name}\n' \
          'Ваш id - {id}\n' \
          'Доступ - {access}'


access_no_info = '❕ Информация о Pyramid Cheops\n\n' \
                 '💥 Пирамида имеет 3 уровня\n' \
