...
menu_access_no.add(
    types.InlineKeyboardButton(text='Инвестиции', callback_data='buy_access'),                       # +
    types.InlineKeyboardButton(text='Кошелек', callback_data='profile'),                                # +
    types.InlineKeyboardButton(text='Партнёрам', callback_data='access_no_info'),                       # +
...
menu_access_yes.add(
    ...
    types.InlineKeyboardButton(text='Калькулятор', callback_data='access_yes_info'),                     # +
...
menu_admin.add(
    types.InlineKeyboardButton(text='Настройки', callback_data='admin_info'),                          # +
